...
public enum GenerateTransactionEventObject {
	...
	public static JsonObject generate(JsonObject info, JsonObject prerequisites, String transactiontype, String transactionID) {
		String owner = SystemObjectInformation.determineOwner();
		String publicS = owner;
		String keyword = transactiontype.substring(8);
		JsonObject json = BaseCatalogData.createStandardDatabaseObject(transactiontype, 
				owner, transactionID, publicS);
		GenerateTransactionEventObject generate = GenerateTransactionEventObject.valueOf(keyword);

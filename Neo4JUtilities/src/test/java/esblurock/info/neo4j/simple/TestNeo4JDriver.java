...
public class TestNeo4JDriver {
	...
	public void openDriver() {
		try {
			...
			/*
		    AuthToken auth = AuthTokens.basic("neo4j", "dIF3WXZEPVljjlFrjAtSb9f9r_Rv55QaWDNNUcjOsGw");
		    Driver driver = GraphDatabase.driver("neo4j+s://f722f1a0.databases.neo4j.io", auth);
